...
> [!Note]
> Multiple I2C Modules can be connected to the same SDA/SCL pins but there will be conflicts if multiple modules have the same addressing.

> [!Note]
> These are generic I2C LCD modules — the small contrast potentiometer on the back of the I2C backpack may need to be adjusted (using a small screwdriver) before any text becomes clearly visible on the display.
